...
- **Security-sensitive Aktionen** nutzen One-Time-MFA-Action-Grants; bei 2FA-pflichtigen Accounts muss jede sensible Aktion genau einen frischen Grant konsumieren. Alte JWTs ohne Login-MFA-Assurance werden nach 2FA-Aktivierung/Policy für normale API-Auth abgelehnt. Der nicht-sensitive 2FA-Status bleibt für gültige interaktive JWTs lesbar, damit Clients den richtigen Reauth-Faktor wählen können.
