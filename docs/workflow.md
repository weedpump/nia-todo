...
- During release packaging, the generated download manifest contains exactly the current Windows/Android artifacts; installed servers expose those files under `/downloads/`.
