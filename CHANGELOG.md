...
- Refined app confirmation, danger, native OIDC return, and login surfaces with rounder borderless surfaces and softer icon treatment to match the Next UI direction.
