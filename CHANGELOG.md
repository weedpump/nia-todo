...
- Improved todo card metadata layout so pills stay on the title line for one-line todos, sit beside the title/description block on wide screens, and move below descriptions on narrow screens.
