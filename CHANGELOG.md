...
- Improved todo card metadata layout so pills stay on the title line for one-line todos and sit beside the title/description block when a description exists.
