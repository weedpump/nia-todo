...
- Refined the BrainDump modal toward the shared detail-modal visual language with a wider dynamic shell, quieter header, round icon chip, flatter stage/results surfaces, softer candidate cards, aligned footer actions, clearer audio level bars, and mobile fullscreen sizing.
