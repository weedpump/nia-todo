...
- Refined the Settings modal to follow the shared detail-modal shell with matching sizing, header treatment, flattened section surfaces, round section icons, quieter inner rows/cards, and an aligned close action.
