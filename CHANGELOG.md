...
- BrainDump opens into a voice-first flow that starts recording immediately from the launcher, groups preview candidates by project, and keeps its modal/action layout aligned with the redesigned UI system.
