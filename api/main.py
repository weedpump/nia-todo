...
<body>
    ...
    <div class="hero">
      ...
      <div class="toolbar" aria-label="Display options">
        <div class="admin-theme-toggle">
          <button type="button" data-theme="light" title="Light" aria-label="Light theme"><span data-icon="sun"></span></button>
          <button type="button" data-theme="dark" title="Dark" aria-label="Dark theme"><span data-icon="moon"></span></button>
          <button type="button" data-theme="system" title="System" aria-label="System theme"><span data-icon="monitor"></span></button>
        </div>
      </div>
    </div>
  </header>
  ...
  <script src="/static/js/pages/public-docs.js"></script>
</body>
</html>"""
