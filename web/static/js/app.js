...
import { applyTheme, bindSystemThemeListener, cycleTheme, initTheme, setAccentPreset, setTheme } from './features/theme.js';
...
export function startAppModule() {
  ...
  theme: { initTheme, setTheme, applyTheme, cycleTheme, setAccentPreset },
