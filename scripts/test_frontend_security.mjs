...
assert(downloadsSource.includes("linux: {") && downloadsSource.includes("filenamePrefix: 'nia-todo-desktop-v'") && downloadsSource.includes("filenameSuffix: '-linux-amd64.deb'") && downloadsSource.includes("return ['windows', 'android', 'linux']"), 'app downloads must expose Linux Debian packages from app-downloads manifests');
