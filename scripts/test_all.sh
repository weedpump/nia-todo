...
run_step "2/41 BrainDump-Services-Tests" python3 scripts/test_braindump_v2_services.py
...
run_step "6/41 E-Mail-Service-Tests" python3 scripts/test_email_services.py
...
run_step "9/41 Migration-022-Duplicate-E-Mail-Test" python3 scripts/test_migration_022_email_duplicates.py
