...
def test_branded_email_templates():
    ...
    assert_true("Dein Login-Code lautet: 123456" in code_text, "2FA code should be inline in plain text")
    assert_true("<strong" in code_html and ">123456</strong>" in code_html, "2FA code should render as inline bold text")
    assert_true("code-box" not in code_html, "2FA code should not render as a separate box")
